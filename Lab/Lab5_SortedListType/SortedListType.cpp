...
template <class ItemType>
void SortedListType<ItemType>::GetNextItem(ItemType& item)
{
    currentPos++;
    item = info[currentPos];
}
template <class ItemType>
void SortedListType<ItemType>::InsertItem(ItemType item)
{
    int location, index;
    if (length>=MAX_ITEMS)
        return;
...
template <class ItemType>
void SortedListType<ItemType>::RetrieveItem(ItemType& item, bool& found)
{
